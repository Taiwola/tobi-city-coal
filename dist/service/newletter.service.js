 ...
 */
const addUserEmail = async (user_email, user_firstname, user_lastname, user_contact_number) => {
...
const getAllUserEmail = async () => {
    const newsletter = await newsletter_model_1.default.find();
    return newsletter;
};
 ...
 */
const getOneUserEmail = async (id) => {
    const newsletter = await newsletter_model_1.default.findById(id);
    return newsletter;
};
 ...
 */
const removeUserEmail = async (id) => {
    const newsletter = await newsletter_model_1.default.findByIdAndDelete(id);
    return newsletter;
};
exports.removeUserEmail = removeUserEmail;
//# sourceMappingURL=newletter.service.js.map